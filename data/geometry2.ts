...
export const geometry2Problems: ProblemSet = {
  "二等辺三角形(準)": [
    { type: 'text', data: { question: "頂角が40°の二等辺三角形の一つの底角は何度ですか？", hint: "二等辺三角形の2つの底角は等しいです。また、三角形の内角の和は180°です。" }, answer: "70°" },
    { type: 'text', data: { question: "一つの底角が50°の二等辺三角形の頂角は何度ですか？" }, answer: "80°" },
    { type: 'text', data: { question: "二等辺三角形の底辺の両端の角を何といいますか？" }, answer: "底角" },
    { type: 'text', data: { question: "二等辺三角形の頂角の二等分線は、底辺をどのように分けますか？" }, answer: "垂直に二等分する" },
    { type: 'text', data: { question: "AB=ACの二等辺三角形ABCがあります。∠Bが65°のとき、∠Aは何度ですか？" }, answer: "50°" },
    { type: 'text', data: { question: "二等辺三角形の定義を答えなさい。" }, answer: "2つの辺が等しい三角形" },
    { type: 'text', data: { question: "二等辺三角形の底角が等しいことは、定義ですか、定理ですか？" }, answer: "定理" },
    { type: 'text', data: { question: "頂角が120°の二等辺三角形の一つの底角は何度ですか？" }, answer: "30°" },
    ...
    { type: 'text', data: { question: "頂角の外角が100°の二等辺三角形の底角は何度ですか？" }, answer: "50°" },
    { type: 'text', data: { question: "底角の一つの外角が110°の二等辺三角形の頂角は何度ですか？" }, answer: "40°" },
    { type: 'text', data: { question: "AB=ACの二等辺三角形ABCで、頂点Aから辺BCに垂線を引くと、その線は∠Aをどうしますか？" }, answer: "二等分する" },
